...
//static NSString *webURLString = @"http://v.youku.com/v_show/id_XMTY4NDc0MDU3Mg==.html";
static NSString *webURLString = @"www.baidu.com";
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    // @"http://share.ishenzang.com:1234/h5/ShowLectureNotification/lw123"
    [self.webView loadRequest:request];
    
    [self.webBackView addSubview:self.webView];
...
- (IBAction)PUSH:(id)sender {
    ...
    TestPSController *pvc = [[TestPSController alloc] init];
